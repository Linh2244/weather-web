...
export async function fetchWeather(lat, lon) {
  const params = new URLSearchParams({
    ...
    current: 'temperature_2m,relative_humidity_2m,apparent_temperature,precipitation,weather_code,wind_speed_10m,wind_direction_10m,uv_index,surface_pressure,dew_point_2m,visibility',
    hourly: 'temperature_2m,relative_humidity_2m,apparent_temperature,precipitation,precipitation_probability,weather_code,wind_speed_10m,uv_index,surface_pressure,dew_point_2m,visibility',
